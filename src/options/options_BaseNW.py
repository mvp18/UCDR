...
class Options:
    ...
    def __init__(self):
        ...
        parser = argparse.ArgumentParser(description='Base NW for UCDR/ZS-SBIR')
        ...
        parser.add_argument('-data', '--dataset', default='DomainNet', choices=['Sketchy', 'TUBerlin', 'DomainNet'])
        ...
        parser.add_argument('-wmse', '--wmse', default=0.0, type=float, help='Weight on euclidean-based mse loss')
