...
class Options:
    ...
    def __init__(self):
        ...
        parser = argparse.ArgumentParser(description='SAKE for ZS-SBIR')
        
        parser.add_argument('-root', '--root_path', default='/data/soumava/datasets/', type=str)
        parser.add_argument('-path_cp', '--checkpoint_path', default='/data/soumava/saved_models/SAKE/', type=str)
